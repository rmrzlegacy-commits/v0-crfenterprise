...
async function startServer() {
  ...
  app.get("/api/capability-statement", (_req, res) => {
    try {
      ...
      doc.fontSize(11).fillColor("#000000").font("Helvetica-Bold").text("Active · FY2026", col2x, y + 12);

      y += 40;
      doc.fontSize(8).fillColor("#7a7a90").font("Helvetica-Bold").text("CERTIFICATIONS", col1x, y);
      doc.fontSize(11).fillColor("#000000").font("Helvetica-Bold").text("MWBE Certified · Small Business Set-Aside Eligible", col1x, y + 12);
      ...
      doc.fontSize(8).fillColor("#7a7a90").font("Helvetica").text(
        "CRF Enterprise, LLC  ·  crfenterprise.com  ·  CAGE: 107F5  ·  SAM Registered  ·  MWBE Certified  ·  Updated FY2026",
